...
public class Laser {
    ...
    public Laser(Context context, int screenSizeX, int screenSizeY, int spaceShipX, int spaceShipY, Bitmap spaceShip, boolean isEnemy){
        ...
        mBitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.cube_1);
        mBitmap = Bitmap.createScaledBitmap(mBitmap, mBitmap.getWidth() * 3/5, mBitmap.getHeight() * 4/5, false);
