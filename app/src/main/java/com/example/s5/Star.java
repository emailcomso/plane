...
public class Star {
    ...
    private int[] mClouds = new int[]{R.drawable.cloud1, R.drawable.cloud2, R.drawable.cloud3};
    ...
    public Star(Context context, int screenSizeX, int screenSizeY, boolean randomY){
        ...
        mBitmap = BitmapFactory.decodeResource(context.getResources(), mClouds[random.nextInt(3)]);
